...
output_dir="/home/damian/Documents/L3S/projects/sars_cov2/data/exp_epitopes_input/blast"
...
blastp -task blastp-short -query $input_dir"/immunodom_regions_P59632.fasta" -db $output_dir"/sars_cov2_SMN3a" -max_target_seqs 1 -max_hsps 1 -evalue 10 -outfmt '6 qseqid sseqid length qlen slen qstart qend sstart send pident evalue' -out $output_dir"/P59632_blastp_sars_cov2.tsv" -threshold 1 -num_threads 2
